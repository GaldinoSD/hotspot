...
const dashboardFinanceiroRoutes = require("./src/routes/dashboardFinanceiroRoutes");
...
app.use("/api/dashboard-financeiro", auth, tenant, checkPermissao('pagamentos'), dashboardFinanceiroRoutes);
