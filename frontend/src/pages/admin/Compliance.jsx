    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <PageHeader
          ...
          subtitle="Consulta de registros conforme Marco Civil da Internet (Lei 12.965/2014)"
          icon={
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/></svg>
          }
        >
          <button
            onClick={exportarCSV}
            className="flex items-center gap-2 px-4 py-2.5 bg-green-700 hover:bg-green-600 text-white rounded-xl transition-colors text-sm font-medium"
          >
