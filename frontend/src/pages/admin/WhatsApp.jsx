...
export default function WhatsApp() {
  ...
  return (
    <AdminLayout>
      <PageHeader
        title="WhatsApp"
        subtitle="Integração e envio de mensagens automáticas"
        icon={
          <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 20l1.3-3.9A9 9 0 113.9 18.7L3 20zm9-14a7 7 0 00-5.9 10.7l.3.5-.8 2.3 2.4-.8.5.3A7 7 0 1012 6z"/></svg>
        }
      />
          ...
          <div>
            ...
            {status.state === "open" && (
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-[#0f111a] rounded-lg p-4 text-center">
                  <p className="text-2xl font-bold text-emerald-400">{status.chats_count}</p>
