                    ...
                    <div className="p-3 bg-[#12141c] rounded-xl border border-gray-800 space-y-3">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-[#0d1117] border border-gray-700 text-gray-300 text-xs rounded-lg px-3 py-2 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
                        >
                  ...
                  <div className="pt-3 border-t border-gray-800 space-y-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-[#12141c] border border-gray-700 text-gray-300 text-xs rounded-lg px-3 py-2 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
                      >
