  ...
  return (
    <AdminLayout>
      <div className="p-6 bg-[#0f111a] min-h-screen text-white">
        <PageHeader
          title="Sessões RADIUS"
          subtitle="Histórico de conexões e registros RADIUS"
          icon={
        ...
        >
          <button
            onClick={exportCSV}
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 text-white hover:bg-blue-500 text-sm font-medium transition-all"
            title="Exportar CSV"
          >
