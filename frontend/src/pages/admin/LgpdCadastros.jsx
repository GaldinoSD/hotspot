    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="bg-gradient-to-br from-[#1b1e2c] to-[#121420] rounded-2xl border border-blue-900/25 p-5 shadow-lg relative overflow-hidden group hover:scale-[1.02] transition-all duration-300">
            ...
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Total de Registros</span>
              <div className="p-2 bg-blue-500/10 rounded-xl text-blue-400"><ShieldCheck className="w-4 h-4" /></div>
            </div>
            <div className="mt-3">
              <div className="text-3xl font-bold text-white group-hover:scale-[1.02] transition-transform duration-200">{stats.total}</div>
              <div className="text-[10px] text-gray-500 mt-1">Consentimentos na base</div>
            </div>
          </div>

          <div className="bg-gradient-to-br from-[#122220] to-[#0e171b] rounded-2xl border border-emerald-900/25 p-5 shadow-lg relative overflow-hidden group hover:scale-[1.02] transition-all duration-300">
            ...
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Aceites</span>
              <div className="p-2 bg-emerald-500/10 rounded-xl text-emerald-400"><CheckCircle2 className="w-4 h-4" /></div>
            </div>
            <div className="mt-3">
              <div className="text-3xl font-bold text-emerald-400 group-hover:scale-[1.02] transition-transform duration-200">{stats.aceitos}</div>
              <div className="text-[10px] text-gray-500 mt-1">Termos aceitos pelos usuários</div>
            </div>
          </div>

          <div className="bg-gradient-to-br from-[#2d1e1e] to-[#171212] rounded-2xl border border-red-900/25 p-5 shadow-lg relative overflow-hidden group hover:scale-[1.02] transition-all duration-300">
            ...
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Recusados</span>
              <div className="p-2 bg-red-500/10 rounded-xl text-red-400"><XCircle className="w-4 h-4" /></div>
            </div>
            <div className="mt-3">
              <div className="text-3xl font-bold text-red-400 group-hover:scale-[1.02] transition-transform duration-200">{stats.recusados}</div>
              <div className="text-[10px] text-gray-500 mt-1">Termos rejeitados pelos usuários</div>
            </div>
          </div>
        </div>
