...
export default function CadastroLead() {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center text-white px-4 py-8 ${!bgStyle ? 'bg-gradient-to-br from-emerald-800 via-teal-900 to-cyan-950' : ''}`} style={bgStyle}>
